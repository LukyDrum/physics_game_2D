...
impl Body for Line {
    fn closest_surface_point(&self, point: Vector2<f32>) -> SurfacePoint {
        ...
        SurfacePoint { point, surface_normal: self.unit_normal } 
    }
...
#[cfg(test)]
mod tests {
    use crate::{math::Vector2, physics::rigidbody::{Body, Line}};
    ...
    fn closest_point_on_line() {
        ...
        assert_eq!(line.closest_surface_point(point).point, Vector2::new(3.0, 0.0))
    }
}
